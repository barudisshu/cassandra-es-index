...
public class IndexConfiguration implements IndexConfig {
  ...
  @Nonnull
  @Override
  public Set<String> getJsonSchemaFields() {
    return getFields(ES_JSON_SCHEMA_FIELDS);
  }
  ...
  @Override
  public boolean isDetectGeo() {
    return reader.getBoolean(ES_DETECT_GEO, ES_DETECT_GEO_DEF);
  }
