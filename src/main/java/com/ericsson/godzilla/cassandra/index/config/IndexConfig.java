...
public interface IndexConfig {
  ...
  String ES_DETECT_GEO = "detect-geo";
  boolean ES_DETECT_GEO_DEF = true;
  ...
  String ES_INDEX_MANAGEMENT_DEF = "com.ericsson.godzilla.cassandra.index.DefaultIndexManager";
  ...
  /**
   * https://intranet.godzilla.com/display/GPE/WCC+ElasticSearch+Cassandra+Index#WCCElasticSearchCassandraIndex-json-serialized-fields
   *
